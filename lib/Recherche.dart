...
class _ChercherPageState extends State<ChercherPage> {
  ...
  Future<void> searchProduct() async {
    try {
      final String baseUrl = "http://localhost/presta/api/products";
      final String apiKey = "HXK91J3162VDCQR8DAZD7Y77PT1Z76WD";
  ...
  Future<void> getProductDetails(String productId) async {
    try {
      final String baseUrl = "http://localhost/presta/api/products/$productId";
      final String apiKey = "HXK91J3162VDCQR8DAZD7Y77PT1Z76WD";
      ...
      if (response.statusCode == 200) {
        final xmlDoc = xml.XmlDocument.parse(response.body);
        final productName = xmlDoc
            .findAllElements("name")
            .first
            .text;
        final productPrice = xmlDoc
            .findAllElements("price")
            .first
            .text;
      ...
      body: Padding(
        ...
        child: Column(
          children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(color: Colors.black),  // Ici, mettez la couleur que vous voulez
                      hintText: 'Entrez le nom du produit',
                      focusedBorder: UnderlineInputBorder(
                        borderSide: BorderSide(color: Color.fromRGBO(255, 181, 0, 1), width: 2.0),
                      ),
            ...
            SizedBox(height: 16),
            Center(  // Ajoutez ce widget pour centrer le texte
              child: Text(
                _result,
                style: TextStyle(
                  fontWeight: _result == "Aucun produit trouvé!" ? FontWeight.bold : FontWeight.normal,  // En gras si "Pas de résultats"
                  color: _result == "Aucun produit trouvé!" ? Colors.grey : Colors.black,  // Gris si "Pas de résultats"
                ),
              ),
            ),
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final imageUrl = "http://localhost/presta/api/images/products/${product.id}/${product.imageId}?ws_key=HXK91J3162VDCQR8DAZD7Y77PT1Z76WD";
                  return Card(
